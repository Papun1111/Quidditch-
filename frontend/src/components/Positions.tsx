...
const Card3D: React.FC<Card3DProps> = ({ children, rotation = 5 }) => {
...
function useSpotlight(ref: RefObject<HTMLDivElement>) {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // If inside the container, show spotlight; otherwise hide
      if (
        xPos >= 0 &&
        yPos >= 0 &&
        xPos <= rect.width &&
...
const Sparkline: React.FC<SparklineProps> = ({ isLoss, delay = 0 }) => {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        {/* Header */}
        <motion.div className="flex items-center mb-10" variants={headerVariants}>
                  ...
                  <Card3D>
                    ...
                    >
                      ...
                      <div className="relative mb-4">
                        <motion.h3
                          className={`text-3xl font-extrabold text-white uppercase text-center ${
                            position.isLoss ? "text-red-50" : "text-green-50"
                          }`}
                        ...
                        <div
                          className={`absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-1/2 h-[2px] ${
                            position.isLoss ? "bg-red-500" : "bg-green-500"
                          } blur-sm`}
                        />
                      </div>
                      ...
                      {/* Bottom Glow Effect */}
                      <div
                        className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-2/3 h-[2px] ${
                          position.isLoss
