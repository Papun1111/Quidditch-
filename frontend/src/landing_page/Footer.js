  ...
  return (
    ...
    <div className="container border-top mt-5" >
      <div className="row mt-5">
        ...
        <p>&copy;2022-2024 Not Zerodha Broking Ltd All rights reserved </p>
        </div>
        <div className="col">
          <p>Company</p>
          ...
          <a href="">Zeerodha cares (CSR)</a><br></br>
        </div>
        <div className="col">
          <p>Support</p>
           ...
           <a href="">Downloads & resouces</a><br></br>
        </div>
        <div className="col">
          <p>Account</p>
          <a href="">Open an Account</a><br></br>
          <a href="">Fund transfer</a><br></br>
          <a href="">60day challenge</a><br></br>
        </div>
      </div>
