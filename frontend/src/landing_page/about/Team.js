    ...
    <div className="container">
      ...
      <div className="row p-5 mt-5 text-muted">
        <div className="col-6 p-5 fs-6 text-center">
          <img style={{ borderRadius: "100%", width: "50%" }} src="/media/Ceo.jpg"></img>
          <h4 className="mt-5">Papun Mohapatra</h4>
          <h6>Founder, CEO</h6>
        </div>
        <div className="col-6 p-3">
          ...
          <p>
           He is a student at Siksha O Anusandhan ,passionate about Web Dev and BlockChain
          </p>
